    ...
    public class AppDbContext: IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            for (int j = 1; j <= 52; j++)
            {
                ...
                modelBuilder.Entity<Storage>().HasData(new Storage { Week = j, Year = 2020,
                                                                    Pie_id_1_stock = random.Next(0, 10),
                                                                    Pie_id_2_stock = random.Next(0, 10),
                                                                    Pie_id_3_stock = random.Next(0, 10),
                                                                    Pie_id_4_stock = random.Next(0, 10),
                                                                    Pie_id_5_stock = random.Next(0, 10),
                                                                    Pie_id_6_stock = random.Next(0, 10),
                                                                    Pie_id_7_stock = random.Next(0, 10),
                                                                    Pie_id_8_stock = random.Next(0, 10),
                                                                    Pie_id_9_stock = random.Next(0, 10),
                                                                    Pie_id_10_stock = random.Next(0, 10),
                                                                    Pie_id_11_stock = random.Next(0, 10)
                });
